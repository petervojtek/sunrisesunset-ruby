...
== USAGE:
    ...
    date = Date.parse('2013-04-07') 
    calc = SolarEventCalculator.new(date, BigDecimal.new("48.1485"), BigDecimal.new("17.1067"))
    if (calc.compute_utc_civil_sunset < Time.now.to_datetime)
        puts "morning has broken"
    end
